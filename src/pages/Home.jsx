...
const Home = () => {
  return (
    <div className="vidintro">
      <div className=" m-0">
        <iframe className="w-[100vw] h-[18rem]" src="https://www.youtube.com/embed/DsKiW4ykDW0?si=vqUhSqFns9r9_d0C" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
      </div>
