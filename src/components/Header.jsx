      ...
      <AppBar position="static">
        <Container maxwidth='xl'>
          <Toolbar disableGutters>
            <AccountBalanceIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 2 }} />
            <Typography
              variant="h6"
              noWrap
              component="a"
          ...
          >
            <MenuItem onClick={handleCloseServicesMenu}>Service 1</MenuItem>
            <MenuItem onClick={handleCloseServicesMenu}>Service 2</MenuItem>
            <MenuItem onClick={handleCloseServicesMenu}>Service 3</MenuItem>
        ...
        >
          ...
          >
            Services
                ...
                <MenuItem onClick={handleCloseNavMenu} sx={{ color: 'success.main' }}>Open an Account</MenuItem>
              </Menu>
            </Box>
            <Typography
              variant="h5"
          ...
          >
            Services
              ...
              <Button variant='outlined' sx={{ color: "white", ml:"auto", display:{xs:'block'}}}>Login</Button>
